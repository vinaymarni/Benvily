    ...
    <div className="flex">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2">Manage Stylists</h1>
            <p className="text-muted-foreground">
              View and manage all Stylists in your network
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{stylists.length} Stylists in your network</CardDescription>
          </CardHeader>
          <CardContent>
